			...
			<div class="pr_rzd">
				...
				<div class="pr_rzd_2">
					<div v-if="!datad.is_contributor">
						<img src="https://static.zookingsoft.com/SVR_NEW_DESIGNER_WEB/imge/project/rz_01.svg" alt="">
						<div>完成供稿人认证</div>
						<div @click="gorz()" class="btns btns_js pend">立即认证</div>
					</div><div @click="goTo('/upload')" v-if="datad.work_num!=3">
						<img src="https://static.zookingsoft.com/SVR_NEW_DESIGNER_WEB/imge/project/rz_02.svg" alt="">
						<div>上传并通过3个原创作品（{{datad.work_num}}/3）</div>
						<div class="btns btns_js pend">立即创作</div>
					</div><div v-if="!datad.is_complete">
						<img src="https://static.zookingsoft.com/SVR_NEW_DESIGNER_WEB/imge/project/rz_03.svg" alt="">
						<div>完善个人能力资料</div>
