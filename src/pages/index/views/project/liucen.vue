...
export default {
	data(){
		return{
			shareData:{},
			List:[
				{t:'项目报名',L:[{n:'如何报名项目？',u:'/#/help'},{n:'如何报名项目？',u:'/#/help'}]},
				{t:'项目中标',L:[{n:'如何提高中标率？',u:'/#/help'},{n:'如何得知是否中标？',u:'/#/help'}]},
				{t:'项目制作',L:[{n:'项目要求是什么？',u:'/#/help'},{n:'特殊原因无法制作？',u:'/#/help'}]},
				{t:'项目交稿',L:[{n:'项目要求是什么？',u:'/#/help'},{n:'交稿延期了怎么办？',u:'/#/help'}]},
				{t:'平台验收',L:[{n:'验收标准是什么？',u:'/#/help'}]},
				{t:'获得收益',L:[{n:'收益价格怎么定？',u:'/#/help'},{n:'什么是分成收益？',u:'/#/help'}]},
