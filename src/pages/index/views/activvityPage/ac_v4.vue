		...
		<div class="ac_v1-1">
			...
			<div class="ac_v1-5">
				...
				<div v-if="navOn==3" class="ac_v1-5-2">
					...
					<img class="ac-04" :src="imgPath+'ac_v4/07.png'">
...
.ac_v1-5-2{
	background: url(https://static.zookingsoft.com/SVR_NEW_DESIGNER_WEB/New/imge/ac_v4/02.png) 0 0/100% auto no-repeat;
	padding: 80px 0 0 0;
