		...
		<div class="header_3">
			...
			<span class="header_4" v-if="userMssge">
				...
				<div  class="userBpx">
					...
					<ul> 
						<a @click="goZP('/projectBm','我的项目')"><li><img class="svgImg2" src="https://static.zookingsoft.com/SVR_NEW_DESIGNER_WEB/img/svg/head/home_grxx_tk_icon_wdxm.svg" alt="" />我的项目</li></a>						
