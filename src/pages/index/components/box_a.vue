		...
		<div class="list1_box_3">
			...
			<div class="list1_box_3_3">
				...
				<div class="list1_box_3_4" @click="openxq()">
					<span class="pend"><img  class="ImgSvg" src="https://static.zookingsoft.com/SVR_NEW_DESIGNER_WEB/img/svg/see/zs_icon_gk.svg">{{el.view_num}}</span>
					<span class="pend"><img class="ImgSvg tof2d" src="https://static.zookingsoft.com/SVR_NEW_DESIGNER_WEB/img/svg/see/zs_icon_dz.svg">{{el.like_num}}</span>
					<span class="pend"><img class="ImgSvg tof1d" src="https://static.zookingsoft.com/SVR_NEW_DESIGNER_WEB/img/svg/see/zs_icon_xx.svg">{{el.comment_num}}</span>
				</div>
			</div>
		</div>
