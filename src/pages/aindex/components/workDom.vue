<template>
	<div v-if="el && el.user_info" class="worksBox">
		...
		<div class="worksBox_n">
			...
			<img class="tjImg" v-if="el.is_recommend==1" src="https://static.zookingsoft.com/SVR_NEW_DESIGNER_WEB/New/imge/new/works/icon_r.svg"/>
		</div>
		...
		<div @click="goPth('user',el.user_info.open_id)" v-if="el.isUser" class="worksUser">
			...
			<div class="worksUser_3">
				<span><img src="https://static.zookingsoft.com/SVR_NEW_DESIGNER_WEB/New/imge/svg/see/zs_icon_xx.svg" alt="">{{el.comment_num}}</span>
				<span><img src="https://static.zookingsoft.com/SVR_NEW_DESIGNER_WEB/New/imge/svg/see/zs_icon_dz.svg" alt="">{{el.like_num}}</span>	
			</div>			
