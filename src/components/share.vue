...
export default {
	...
	methods: {	
		...
		setUrl(da){
			...
			da.url = ncodeURIComponent(da.url);
			...
			this.fxUrl1 = 'http://service.weibo.com/share/share.php?appKey=3473072390&title='+da.title+'&url='+da.url+'&pic='+da.pics+'#_loginLayer_'+(new Date()).valueOf();
			this.fxUrl2 ='https://connect.qq.com/widget/shareqq/index.html?url='+da.url+'&title='+da.title+'&pics='+da.pics+'&desc=&summary='+da.summary+'&site=wo';
			
			this.fxUrl3 = 'https://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url='+da.url+'&title='+da.title+'&pics='+da.pics+'&summary='+da.summary+'&desc=&site=xx';
		},
	},
}
